...
dataset = {
        "tfidf-1":open("data/tfidf-1.txt").read(),
        "tfidf-2":open("data/tfidf-2.txt").read(),
        "tfidf-3":open("data/tfidf-3.txt").read(),
        "tfidf-4":open("data/tfidf-4.txt").read(),
        "tfidf-5":open("data/tfidf-5.txt").read(),
        "tfidf-6":open("data/tfidf-6.txt").read(),
        "tfidf-7":open("data/tfidf-7.txt").read(),
        "tfidf-8":open("data/tfidf-8.txt").read(),
        "tfidf-9":open("data/tfidf-9.txt").read(),
        "tfidf-10":open("data/tfidf-10.txt").read(),
        }
